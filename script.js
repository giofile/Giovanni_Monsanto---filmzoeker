...
const newMoviesList = movies.filter((item)=> item.Year >=2014)
console.log(newMoviesList);


const avengersList = movies
.filter((item)=> item.Title
.includes ("Avengers"))
console.log(avengersList);


const xMenList = movies
.filter( (item)=> item.Title
.includes("X-Men"))
console.log(xMenList);

const princessList = movies
.filter((item)=> item.Title
.includes("Princess"))
console.log(princessList);

const batmanList = movies
.filter((item)=> item.Title
.includes("Batman"))
console.log(batmanList); 


/* queryselect */
const newMoviesBtn = document.querySelector("#nieuwe_films")
const avengersBtn = document.querySelector("#avengers")
const xMenBtn = document.querySelector("#x-men")
const princessBtn = document.querySelector("#princess")
const batmanBtn = document.querySelector("#batman")



/* returned new array for new Movies*/
const newMoviesListArray = [
    {
        "Title": " X-Men: Days of Future Past ",
        "Year": "-2014",
        "imdbID": "tt1877832",
...
// map array voor NewMovies titles
const NewMoviesTitles = newMoviesListArray.map((item)=> item.Title + item.Year)
console.log(NewMoviesTitles);

/* returned new array for Avengers*/
...
// map array voor Avengers titles
const avengerTitles = avengerListArray.map((item)=> item.Title )
console.log(avengerTitles);

/* returned new array for X-Men*/
...
// map array voor X-Men titles

const xMenTitles = xMenListArray.map((item)=> item.Title)
console.log(xMenTitles);

/* returned new array for Princess-reeks*/

const princessListArray =[
    {
        "Title": " The Princess Bride",
        "Year": "1987",
        "imdbID": "tt0093779",
...
// map array voor Princess titles

const princessTitles = princessListArray.map( (item)=> item.Title )
console.log(princessTitles);

/* returned new array for batman-reeks*/

const batmanListArray = [
    {
        "Title": " Batman Begins",
        "Year": "2005",
        "imdbID": "tt0372784",
...
// map array voor Batman titles

const batmanTitles = batmanListArray.map ( (item)=> item.Title)
console.log(batmanTitles);


// radio-eventListener , li creatie

let newLi = document.createElement('li');
let menu = document.getElementById('listdisplay').getElementsByTagName('ul')[0];
...
document.body.addEventListener('change', function(e){
    ...
    let message;
    switch(target.id){
        case "nieuwe_films": message = "Dit zijn onze nieuwste films:" + NewMoviesTitles;
        menu.appendChild(newLi);
        menu.innerHTML = message
        break;
        case "avengers": message =   "In de Avengers Movie-reeks treft u : " + avengerTitles;
        menu.appendChild(newLi);
        menu.innerHTML = message 
        break;
        case "x-men": message = " In de Xmen series treft u : " + xMenTitles;
        menu.appendChild(newLi);
        menu.innerHTML = message
        break;
        case "princess": message = " In de Princess series treft u  : " + princessTitles;
        menu.appendChild(newLi);
        menu.innerHTML = message
        break;
        case "batman": message = " In de Batman reeks treft u: " + batmanTitles;
        menu.appendChild(newLi);
        menu.innerHTML = message
        break
    }   
